...
export const ESSAY_META = {
  ...
  introductionParagraphs: [
    'Between 1900 and 1945 Singapore was administered by two empires in succession. The first framed its rule as the patient unfolding of natural order — rational governance carried westward on Linnaean logic and steam. The second framed its rule as historical destiny — a pan-Asian modernity violently redirected toward Tokyo.',
    'Yet the buildings were the same. The lecture theatres, museum galleries, botanical plots, and rubber estates each changed tenants in February 1942 without changing address. Reading the same sites under opposite imperial logics reveals a structural truth about colonial science: it is not the knowledge that determines the politics, but the politics that decides which knowledge counts.',
...
export const INSTITUTIONS: Institution[] = [
  ...
  },
  {
    ...
    japanese: {
      ...
      bodyParagraphs: [
        'The Japanese renamed the institution Syonan Hakubutsukan and kept it open to the public — a notable decision that distinguished it from the purely military requisitions occurring across the city. The natural history collections were retained largely intact. This was preservation publicised: occupation with a civilised face.',
        ...
        'The Museum performed the same function — territorial legitimation through knowledge display — under an inverted political logic. The same cabinets; the opposite argument. Raffles\' collection had been used to say: this is Britain\'s world to know and govern. Tokugawa\'s museum said: this was always Asia\'s world, now returned.',
      ],
      pullQuote:
  ...
  },
  {
    ...
    british: {
      ...
      bodyParagraphs: [
        'The Ford Motor Company opened its Bukit Timah assembly plant in October 1941, the first Ford factory in Southeast Asia. It assembled cars for the colonial civilian market — a symbol of modern industrial capitalism extending its global reach into the Malayan economy.',
        'The factory\'s civilian function was entirely integrated into the logic of British commercial empire: foreign capital, local labour, metropolitan profit. It was not a colonial institution in the way the Museum or the Gardens were — it was empire operating through commerce, not through the state.',
    ...
    japanese: {
      ...
      bodyParagraphs: [
        ...
        'This distinction — perform the cultural institution, extract the productive one — reveals what the ideology of pan-Asian solidarity actually meant in practice. The Co-Prosperity Sphere was prosperous for one party. The economy, as always, was the lie detector.',
      ],
      pullQuote:
